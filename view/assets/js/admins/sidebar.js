define(function (require, exports, module) {
	...
	const nav = document.getElementById("user-side-bar-open");
		const showNavBar=(admin, links)=>{
			let image;
			if (admin.image) {
				image = `<img width="100%" src="/assets/images/${admin.image}" class="col-7 profile-image"/>`;								
			}else{
							...
							<ul class="dsh-nav-list dsh-inline mb-0" id="dsh-nav-options">
							    ...
							    <li class="dsh-nav-item dsh-nav-user dropdown">
							      <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							        <img class="dsh-user-img rounded-circle float-right" src="/assets/images/${admin.image}" alt="people">
							      </a>
							      <ul class="dropdown-menu dropdown-md dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
							        <li class="dropdown-header media bg-light">
							          <img src="/assets/images/${admin.image}" class="rounded-circle" alt="">
							          <div class="media-body">
							            <h6 class="dsh-semi-bold">@${admin.name}</h6>
							            <p>+234${admin.phonenumber}</p>
							          </div>
							        </li>
							        <li class="dropdown-divider "></li>
						 ...
						 <div class="card bg-background mt-5">
						 	<div class="card-body bg-background">
								...
								<a href="/users/upload/image" class="col-7 text-center"><small >edit</small></a>
						 		<small class="col-12 text-green text-center"><b>@${admin.firstname}</b></small>
						 		</div>
						 	</div>
						 </div>
						 </div>
		...
		const loadDashboard=(response)=>{
				if (response.status === 401) {
					...
					let links;
					if (response.admin.level === 1) {

						      links =  `<div class="mt-5 mx-3">
						          <p class="hover-strides"><a href="/admins/dashboard" class="text-green"><i class="fa fa-home" aria-hidden="true"></i> Home</a></p>
						          <p class="hover-strides"><a href="/admins/profile" class="text-green"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></p>
						          <h6 class="mt-4"><b>Users</b></h6>
						          <p class="hover-strides"><a href="/admins/users" class="text-green"><i class="fa fa-users" aria-hidden="true"></i> Users</a></p>
						          <h6 class="mt-4"><b>Transactions</b></h6>
						          <p class="hover-strides"><a href="/admins/transactions" class="text-green"><i class="fa fa-plus-circle" aria-hidden="true"></i>Transactions</a></p>
						          <h6 class="mt-4"><b>Payment</b></h6>
						          <p class="hover-strides"><a href="/admins/finalcial/transactions" class="text-green"><i class="fa fa-dollar-sign" aria-hidden="true"></i> Transactions</a></p>
						          <p class="hover-strides"><a href="/admins/withdrawals" class="text-green"><i class="fa fa-dollar-sign" aria-hidden="true"></i> Withdrawals</a></p>
						          <p class="hover-strides"><a href="/admins/wallet" class="text-green"><i class="fa fa-landmark" aria-hidden="true"></i> Wallet</a></p>
						          <h6 class="mt-4">Analysis</b></h6>
						          <p class="hover-strides"><a href="#" class="text-green"><i class="fa fa-chart-bar" aria-hidden="true"></i> Users</a></p>
						          <p class="hover-strides"><a href="#" class="text-green"><i class="fa fa-chart-bar" aria-hidden="true"></i> Financials</a></p>
						          <p class="hover-strides"><a href="#" class="text-green"><i class="fa fa-chart-pie fa-spin" aria-hidden="true"></i> Projects</a></p>
						          <h6 class="mt-4"><b>Others</b></h6>
						          <p class="hover-strides"><a href="/admins/settings" class="text-green"><i class="fa fa-cog fa-spin" aria-hidden="true"></i> Settings</a></p>
					...
					showNavBar(response.admin, links);
					
				}
			}


			adminGetRequest("admins/profile", token, "GET", loadDashboard);
	}
})