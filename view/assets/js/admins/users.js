define(function(require, exports, module){
	...
	exports.showUserDatabase=(token, id)=>{	
			...
			<div class="card">
				<div class="card-body">
					...
					<div id="buttons_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
						...
						<thead>
							<tr role="row">
							<th class="sorting_asc" tabindex="0" aria-controls="buttons_datatable" rowspan="1" colspan="1" style="width: 141.25px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">First Name</th>
							<th class="sorting" tabindex="0" aria-controls="buttons_datatable" rowspan="1" colspan="1" style="width: 235.25px;" aria-label="Position: activate to sort column ascending">Last Name</th>
							<th class="sorting" tabindex="0" aria-controls="buttons_datatable" rowspan="1" colspan="1" style="width: 48.25px;" aria-label="Actions: activate to sort column ascending">Actions</th>
							</tr> 
						</thead>
						<tbody>
						...
						${users.map((user, index)=>{												  	
							return   `<tr role="row" class="odd">
									...
									<td>${user.lastname}</td>
									<td><div class="dropleft d-inline-block"><a href="#" class="btn btn-icon btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="lni-more-alt"></i></a><div class="dropdown-menu" x-placement="left-start" style="position: absolute; transform: translate3d(-184px, 0px, 0px); top: 0px; left: 0px; will-change: transform;"><a class="dropdown-item media align-items-center" href="mailto:${user.email}"><i class="lni-envelope"></i><div class="media-body"><h6>Mail</h6><p class="text-muted fs-12">Mail User ${user.email}</p></div></a><a class="dropdown-item media align-items-center" href="tel:+234${user.phonenumber}"><i class="lni-phone"></i><div class="media-body"><h6>Call</h6><p class="text-muted fs-12">Call User on 234${user.phonenumber}</p></div></a></div></td>
							</tr>`;
						})}
						</tbody>
					</table>
