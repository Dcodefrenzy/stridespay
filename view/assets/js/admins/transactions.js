define(function(require, exports, module){
	...
	exports.adminUsersTransactions=(token, id)=>{	
		...
		const html = `<div id="revert" class="dsh-content-wrapper col-12 col-sm-12 col-md-9 offset-md-3 col-lg-10 offset-lg-2 col-xl-10 offset-xl-1">
			...
			<div class="breadcrumb-wrapper d-flex align-items-start align-items-sm-center justify-content-between flex-column flex-sm-row">
				<div class="breadcrumb-wrapper--inner d-flex flex-column-reverse">
					<h1><i class="fa fa-users" aria-hidden="true"></i> Transactions</h1>
				...
				<div class="card-body">
					...
					<div id="buttons_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
						...
						<thead>
							...
							<th class="sorting" tabindex="0" aria-controls="buttons_datatable" rowspan="1" colspan="1" style="width: 235.25px;" aria-label="Position: activate to sort column ascending">Client</th>
							<th class="sorting" tabindex="0" aria-controls="buttons_datatable" rowspan="1" colspan="1" style="width: 48.25px;" aria-label="Actions: activate to sort column ascending">Product/Service</th>
							<th class="sorting" tabindex="0" aria-controls="buttons_datatable" rowspan="1" colspan="1" style="width: 48.25px;" aria-label="Actions: activate to sort column ascending">Amount/Payment Status</th>
							</tr> 
						</thead>
						<tbody>
						...
						${transactions.map((transaction, index)=>{	
							...
							return   `<tr role="row" class="odd">
									<td tabindex="0" class="sorting_1">${transaction.creator}</td>
									<td>${buyer.firstname}</td>
									<td>${transaction.productName}</td>
									<td><p>${transaction.currency} ${transaction.price.toString().slice(0, -2)}</p> <p>Payment status: <b>${transaction.paymentStatus}</b></p><p>Transaction Complete: ${transaction.transactionComplete}</p></td>
							</tr>`;
						})}
						</tbody>
					</table>
			...
			const loadDashboard=(response)=>{
				...
				if (response.status === 401) {
					...
					transactions(response.users, response.transactions);
				}
			}
