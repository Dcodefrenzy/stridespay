define(function (require, exports, module) {
	...
	let sideBar;
	 exports.sideBar2=(token, id)=>{
	const {updateNotification} = require("./updatePlayerId");
	const {loading} = require("../loading");
	const {getRequest} = require("request");
	const {loginForm} = require("../logins");
	const {logout} = require("./logout");
	const {showSideBar} = require("./sidebarreturn")
	const {showToggle} = require("./sideBarToggle");
	const body = document.getElementById("body");
		...
		const html = `  <div class="bg-background col-12 col-sm-12 col-md-9 offset-md-3 col-lg-10 offset-lg-2 col-xl-10 offset-xl-1">
							    ...
							    <li class="dsh-nav-item dsh-nav-user dropdown">
							      ...
							      <ul class="dropdown-menu dropdown-md dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
							        <li class="dropdown-header media bg-light">
							          <img src="/assets/stridespay/img/people/people-5-sm.jpg" class="rounded-circle" alt="">
							          <div class="media-body">
							            <h6 class="dsh-semi-bold">Hi, Stephany!</h6>
							            <p>stephdubidup@1987</p>
							          </div>
							        </li>
							        <li class="dropdown-divider "></li>
							        <li class="dsh-dropdown-list">
							          ...
							          <a class="media" href="#">
							            ...
							            <span class="dsh-svg-icon svg-danger">
