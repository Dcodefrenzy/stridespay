define(function(require, exports, module) {
	...
	loading(id, "display-none")
	 ...
	 const	html = `<main id="createNewUser" class="body-content clearfix fixed">
		...
		<div class="row no-gutters min-100vh">
			...
			<div class="col-lg-4 bg-white">
				<div class="dsh-auth-form d-flex flex-column align-items-center justify-content-between py-5">
					...
					<p>Please sign up if you have have an account <b id="createNewUser" onclick="return showLoginForm(event, id)" class="text-primary">Login</b></p>
						</form>
					</div>
					<!--
