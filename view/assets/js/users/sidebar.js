						 ...
						 <div class="card">
						 	<div class="card-body">
						        ...
						        <div class="mt-5 mx-3">
						          ...
						          <p class="hover-strides"><a href="/users/dashboard"><i class="fa fa-cog fa-spin" aria-hidden="true"></i> Settings</a></p>
						          <p class="hover-strides"><a href="/users/dashboard"><i class="fa fa-arrow-left" aria-hidden="true"></i> Log out</a></p>
